...
const About = () => (
  <Background>
    ...
    <Content>
      <p>
        Olá! Meu nome é Benji, tenho 26 anos e eu crio arte para web 😊. <br />
        ...
        Trabalhar remotamente aprimorou minha organização, enquanto o estudo de
        desenho elevou minha criatividade para criar designs inovadores.
      </p>
      <p>
      ...
      <p>Algumas tecnologias que estou usando:</p>
      <div>
        <ul>
          <li>HTML</li>
          <li>Spring Boot</li>
